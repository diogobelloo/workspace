...
btnTarefa.addEventListener('click' , () => {
    if(! inputTarefa.value) return;  // Se meu input.value não tiver nada, retorna ele mersmo.
    criaTarefa(inputTarefa.value); //chamando a função para criar as tarefas quando eu clicar ou prescionar enter.
})
